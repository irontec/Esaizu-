 ...
 */
Class Plugins_Twitter_Render extends Common_Render
{
    /**
     * @return void
     */
    ...
    public function getPublishFormView()
    {
        ...
        return "plugins/twitter/publish";
    }
    ...
    {
        return $this->_ci->load->view("plugins/twitter/message", array("message" => $obj), $return);
    }
}
