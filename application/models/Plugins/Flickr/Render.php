 ...
 */
Class Plugins_Flickr_Render extends Common_Render
{
    /**
     * @return void
     */
    ...
    /**
     * Devuelve el formulario para la creación de una nueva identidad del tipo linkedin
     *
     * @return boolean
     *
     * (non-PHPdoc)
    ...
    /**
     * Devuelve la vista para la publicación de contenido en una identidad linkedin.
    ...
    {
        return $this->_ci->load->view("plugins/flickr/message", array("message" => $obj), $return);
    }
}
